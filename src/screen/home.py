...
"padding: 10px;")
        ...
        self.subgoalWidget.setGeometry(QtCore.QRect(530, 320, 451, 301))
        ...
        self.subgoalScrollArea_nw.setGeometry(QtCore.QRect(10, 230, 431, 301))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.subgoalScrollArea.setStyleSheet("background-color: white;")
        ...
        self.descriptionWidget.setGeometry(QtCore.QRect(530, 80, 451, 191))
        ...
        self.descriptionScrollArea.setGeometry(QtCore.QRect(0, 0, 451, 191))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 451, 191))
        ...
        self.goalDescription.setSpacing(5)
        ...
        self.filler.setGeometry(QtCore.QRect(510, -2, 521, 61))
        ...
        self.dummyThingy = QtWidgets.QWidget(self.verticalLayoutWidget)
        self.dummyThingy.setStyleSheet("background-color: white;")
        self.dummyThingy.setObjectName("dummyThingy")
        self.endDateLayout.addWidget(self.dummyThingy)
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(510, -10, 491, 1000))
...
"")
        ...
        self.label.setGeometry(QtCore.QRect(20, 290, 81, 41))
        self.label.setStyleSheet("color: dark-gray; font-size: 20px;")
        self.label.setObjectName("label")
        self.verticalLine = QtWidgets.QFrame(self.centralwidget)
        self.verticalLine.setGeometry(QtCore.QRect(510, 0, 2, 850))
        ...
        self.horizontalLine.setGeometry(QtCore.QRect(-113, 50, 1261, 2))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Subgoals"))
